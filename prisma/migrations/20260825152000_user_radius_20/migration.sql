...
INSERT INTO "new_User" (
    "id", "telegramId", "whatsappPhone", "viberId", "username", "firstName", "lastName", "registeredAt",
    "silentMode", "isAdmin", "locale", "isBanned", "lat", "lon", "radiusKm",
    "oblastCode", "locationUpdatedAt"
)
SELECT
    "id", "telegramId", "whatsappPhone", "viberId", "username", "firstName", "lastName", "registeredAt",
    "silentMode", "isAdmin", "locale", "isBanned", "lat", "lon",
    CASE WHEN "radiusKm" = 40 THEN 20 ELSE "radiusKm" END,
    "oblastCode", "locationUpdatedAt"
FROM "User";
DROP TABLE "User";
